...
To use:
* install one of the "patched fonts from Vim-Powerline":https://github.com/Lokaltog/vim-powerline/wiki/Patched-fonts or "patch your own":https://github.com/Lokaltog/vim-powerline/tree/develop/fontpatcher for the special characters.
...
Clean, simple, compatible and meaningful. ("more info":http://ysmood.org/wp/2013/03/my-ys-terminal-theme/)
