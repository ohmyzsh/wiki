...
- [git-clean-branches](https://github.com/adelbeke/git-clean-branches): interactive git branch deletion tool with a beautiful UI powered by gum, showing branch info with last commit date and message. 
