...
3. Make it your default shell: `chsh -s $(which zsh)`, or, if you are on Fedora, use `sudo chsh $USER` for recent Fedora versions or `sudo lchsh $USER` for older Fedora versions.
